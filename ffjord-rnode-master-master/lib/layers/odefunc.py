...
class ODEnet(nn.Module):
    ...
    def __init__(
        self, hidden_dims, input_shape, strides, conv, layer_type="concat",
        nonlinearity="softplus", num_squeeze=0, zero_last_weight=True
    ):
        ...
        for dim_out, stride in zip(hidden_dims + (input_shape[0],), strides):
            ...
            if stride is None:
                ...
                layer_kwargs = {"ksize": 1, "stride": 1, "padding": 0, "transpose": False}
            elif stride == 1:
